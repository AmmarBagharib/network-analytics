...
closeness_vector <- closeness(g2000_filtered)
...
Overall, the closeness centrality values are generally very low, with a maximum of no more than 0.00116. Nonetheless, here are some findings:

Based on Figure \@ref(fig:filtered-close-plot) over 120 out of 161 countries have closeness centrality $\ge$ 0.000702, which is relatively high.
...
# Step 1: Read the edge list from the .txt file
file_path_2005 <- here("indiv-project/trade-network/2000.net")
g2000 <- read_graph(file_path_2000,format="pajek")
